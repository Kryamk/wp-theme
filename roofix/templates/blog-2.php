...
if ( RDTheme::$layout == 'full-width' ) {
    ...
    $post_class = 'col-lg-6 col-md-6 no-equal-item';
}
else{
    $layout_class = 'col-md-8 col-xs-12';
    $post_class = 'col-lg-12 col-md-12 no-equal-item';
}
$args = array(
	'post_type' => "post",
);
				...
				<main id="main" class="site-main site-index">
					<?php if ( have_posts() ) :?>
						...
						while ( have_posts() ) : the_post();
							...
							get_template_part( 'template-parts/archive-blog/content-2', get_post_format() );
							echo '</div>';
						endwhile;
						echo '</div>';
						?>
					...
					<?php else:?>
						<?php get_template_part( 'template-parts/archive-blog/content', 'none' );?>
					<?php endif;?>
